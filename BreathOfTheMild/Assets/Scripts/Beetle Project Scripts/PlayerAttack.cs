...
public class PlayerAttack : MonoBehaviour
{
    ...
    */
    ...
    {
        if ((Input.GetButtonDown("Melee Attack") || Input.GetAxis("Melee Attack") > 0.0f) && canAttack && sword.isMonsterHere)
        {
            int attackNumber;
            System.Random random = new System.Random();
            attackNumber = random.Next(15, 35);

            //BRENDAN ADDED CODE HERE
            enemy.DamageEnemy(attackNumber);
            //END BRENDAN CODE

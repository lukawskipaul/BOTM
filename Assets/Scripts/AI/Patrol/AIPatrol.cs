...
// This script allows any Game Object with a NavMesh Agent
// attached to patrol a given route by following a list 
// of Waypoint objects created through the Inspector.
...
public class AIPatrol : MonoBehaviour
{
    ...
    [SerializeField,Tooltip("Decides if the Game Object is going up or down its route list.This way, the Game Object is able to move backwards on its route.")]
    ...
    [SerializeField,Tooltip("The minimum distance between the Game Object and its destination before moving onto the next Waypoint")]
